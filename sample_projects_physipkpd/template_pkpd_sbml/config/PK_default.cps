...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2022-08-16T02:41:56Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <dcterms:creator>
      <rdf:Description>
        <vCard:N>
          <rdf:Description>
            <vCard:Family>Bergman</vCard:Family>
    ...
    <dcterms:modified>
      <rdf:Description>
        <dcterms:W3CDTF>2022-08-15T22:54:10</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:modified>
  </rdf:Description>
</rdf:RDF>
    ...
    <ListOfCompartments>
      <Compartment key="Compartment_0" name="Patient" simulationType="fixed" dimensionality="3" addNoise="false">
        <MiriamAnnotation>
...
<rdf:Description rdf:about="#Compartment_0">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_0" name="circulation_concentration" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"/>

        </MiriamAnnotation>
      </Metabolite>
      <Metabolite key="Metabolite_1" name="periphery_concentration" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
      </Metabolite>
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
      ...
      <ModelValue key="ModelValue_1" name="k12" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
      </ModelValue>
      <ModelValue key="ModelValue_2" name="k21" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
      </ModelValue>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="elimination" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
        <ListOfSubstrates>
      ...
      <Reaction key="Reaction_1" name="Q12" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
        <ListOfSubstrates>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <SBMLReference file="PK_default.xml">
    ...
    <SBMLMap SBMLid="elimination" COPASIkey="Reaction_0"/>
    <SBMLMap SBMLid="k12" COPASIkey="ModelValue_1"/>
    <SBMLMap SBMLid="k21" COPASIkey="ModelValue_2"/>
    <SBMLMap SBMLid="lambda" COPASIkey="ModelValue_0"/>
    <SBMLMap SBMLid="periphery_concentration" COPASIkey="Metabolite_1"/>
  </SBMLReference>
